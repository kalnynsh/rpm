...
apt install -y php7.2-curl php7.2-cli php7.2-intl php7.2-mysqlnd php7.2-gd php7.2-fpm php7.2-mbstring php7.2-xml unzip nginx mysql-server-5.7 php.xdebug
...
mysql -uroot <<< "CREATE DATABASE rpm"
mysql -uroot <<< "CREATE DATABASE rpm_test"
echo "Done!"
